/* empty css                                 */
import { c as createComponent, a as createAstro, m as maybeRenderHead, d as addAttribute, b as renderComponent, r as renderTemplate } from '../chunks/astro/server_D5mPY-J_.mjs';
import 'kleur/colors';
...
import { $ as $$PlayIcon } from '../chunks/PlayIcon_7DSbfK1V.mjs';
...
}, "C:/laragon/www/Splashanime-id/src/components/Carousel.astro", void 0);
  ...
  return renderTemplate`${() => {
    if (home.ok) {
      ...
      return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "seo": {
        ...
        baseUrlPath: "/batch"
      } })}` })}${renderComponent($$result3, "Sidebar", $$Sidebar, {}, { "default": async ($$result4) => renderTemplate`${renderComponent($$result4, "WidgetTitle", $$WidgetTitle, { "title": "Anime Movie", "href": "/movies" })}${renderComponent($$result4, "AnimeList3", $$AnimeList3, { "anime": {
...
}, "C:/laragon/www/Splashanime-id/src/pages/index.astro", void 0);

const $$file = "C:/laragon/www/Splashanime-id/src/pages/index.astro";
const $$url = "";
