/* empty css                                    */
import { c as createComponent, a as createAstro, b as renderComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, F as Fragment } from '../../chunks/astro/server_D5mPY-J_.mjs';
import 'kleur/colors';
...
Tonton
      ...
      })}</div>` })}${renderComponent($$result3, "Sidebar", $$Sidebar, {}, { "default": async ($$result4) => renderTemplate`${renderComponent($$result4, "WidgetTitle", $$WidgetTitle, { "title": "Sidebar" })}` })}` })}` })}`;
    }
...
}, "C:/laragon/www/Splashanime-id/src/pages/anime/[animeId]/index.astro", void 0);

const $$file = "C:/laragon/www/Splashanime-id/src/pages/anime/[animeId]/index.astro";
